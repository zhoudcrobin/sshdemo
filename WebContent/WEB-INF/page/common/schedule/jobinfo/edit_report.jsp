...
<html>
	...
	<body>
		<s:form action="save" namespace="/schedule/jobreport">
				...
				<tr>
					...
					<td colspan="3">
						...
						<s:radio id="start_" name="pageDisplayVo.start" list='#{2:"&nbsp;在"}' value="2" cssStyle="vertical-align: middle;"></s:radio>
						 -->
						<self:datepicker id="startDate" name="pageDisplayVo.startDate" option="inputsimple" format="yyyy-MM-dd HH:mm" disabled="false"/>&nbsp;&nbsp;<font color="red" style="vertical-align: middle;">*</font>
					</td>
				</tr>
				<tr>
					<td>调度方式：</td>
