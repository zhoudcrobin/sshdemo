    ...
    $(opts.datagridId).datagrid({
        ...
        columns:[[
            ...
            {field:'enabled',title:'启用/停用',width:100,align:'center',formatter:function(val,row){
                if (val){
                    return "已启用&nbsp;&nbsp;<a href='#' onclick='inactive(\""+ row.username +"\")'><img src='../../comresource/image/schedule/pause.png' width='13px' height='13px' title='停用操作'/></a>";
                }else {
                    return "已停用&nbsp;&nbsp;<a href='#' onclick='active(\""+ row.username +"\")'><img src='../../comresource/image/schedule/resumed.png' width='13px' height='13px' title='启用操作'/></a>";
                }
              }}
        ]],
