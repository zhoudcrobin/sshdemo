...
import static com.sshdemo.common.lang.EmptyUtil.isArrayNotEmpty;
import static com.sshdemo.common.lang.EmptyUtil.isStringEmpty;

import org.springframework.beans.factory.annotation.Autowired;

import com.sshdemo.common.convert.ConvertException;
import com.sshdemo.common.convert.ConvertFactory;
import com.sshdemo.common.convert.Convertable;
    ...
    protected DataGrid createDataGrid(Resultable result){
        ...
        if(result instanceof CacheResultable){
        	if (total != null && !total.isEmpty())
        		return new DataGrid(((CacheResultable)result).getCacheKey(),result.getCount(), result.getResultList(), total);
        	else
